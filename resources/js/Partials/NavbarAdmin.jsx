            ...
            <div className="px-3 py-3 lg:px-5 lg:pl-3">
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center">
                        ...
                        <div
                            className="z-20 z-50 my-4 hidden max-w-sm list-none divide-y divide-gray-100 overflow-hidden rounded bg-white text-base shadow-lg"
                            ...
                            <div>
                                ...
                                >
                                    ...
                                    <div className="w-full pl-3">
                                        ...
                                        <div className="text-primary-700 text-xs font-medium">
                                            a few moments ago
                                        </div>
                                    </div>
                                </a>
                        ...
                        <button
                            ...
                            className="hidden rounded-lg p-2 text-gray-500 hover:bg-gray-100 hover:text-gray-900 sm:flex"
                        >
                            <span className="sr-only">View notifications</span>
                            <svg
                                className="h-6 w-6"
                        ...
                        >
                            ...
                            <div className="grid grid-cols-3 gap-4 p-4">
                                ...
                                >
                                    <svg
                                        className="mx-auto mb-1 h-7 w-7 text-gray-500"
                                        fill="currentColor"
                                        viewBox="0 0 20 20"
                                        xmlns="http://www.w3.org/2000/svg"
                                    >
                                ...
                                >
                                    <svg
                                        ...
                                        xmlns="http://www.w3.org/2000/svg"
                                    >
                                        <path d="M5 2a2 2 0 00-2 2v14l3.5-2 3.5 2 3.5-2 3.5 2V4a2 2 0 00-2-2H5zm2.5 3a1.5 1.5 0 100 3 1.5 1.5 0 000-3zm6.207.293a1 1 0 00-1.414 0l-6 6a1 1 0 101.414 1.414l6-6a1 1 0 000-1.414zM12.5 10a1.5 1.5 0 100 3 1.5 1.5 0 000-3z"></path>
                                    </svg>
                                    <div className="text-sm font-medium text-gray-900">
                                        Billing
                                    </div>
                        ...
                        <button
                            ...
                            type="button"
                            className="rounded-lg p-2.5 text-sm text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-4 focus:ring-gray-200"
                        >
                            <svg
