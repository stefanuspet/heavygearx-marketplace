                ...
                <div className="flex items-center justify-between">
                    ...
                    <div>
                        ...
                        <button
                            ...
                            type="button"
                            className="focus:ring-primary-300 ml-3 inline-flex items-center justify-center rounded-lg p-2 text-gray-400 hover:text-gray-900 focus:outline-none focus:ring-2 sm:hidden"
