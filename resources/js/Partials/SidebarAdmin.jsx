        ...
        <>
            ...
            >
                <div className="relative flex min-h-0 flex-1 flex-col border-r border-gray-200 bg-white pt-0">
                    <div className="scrollbar-hide flex flex-1 flex-col overflow-y-auto pb-4 pt-5">
                        <div className="flex-1 space-y-1 divide-y divide-gray-200 bg-white px-3">
                            <ul className="space-y-2 pb-2">
                                ...
                                <li>
                                    ...
                                    >
                                        <li>
                                            <a className="group flex items-center rounded-lg bg-gray-100 p-2 pl-11 text-base text-gray-900 transition duration-75 hover:bg-gray-100">
                                                Products
                                            </a>
                                        </li>
                                        <li>
                                ...
                                <li>
                                    <a className="group flex items-center rounded-lg bg-gray-100 p-2 text-base text-gray-900 hover:bg-gray-100">
                                        <svg
                                            className="h-6 w-6 text-gray-500 transition duration-75 group-hover:text-gray-900"
                                            fill="currentColor"
                                            viewBox="0 0 20 20"
                                ...
                                <li>
                                    ...
                                    >
                                        <svg
                                            ...
                                            xmlns="http://www.w3.org/2000/svg"
                                        >
                                            <path d="M6 2a2 2 0 00-2 2v12a2 2 0 002 2h8a2 2 0 002-2V7.414A2 2 0 0015.414 6L12 2.586A2 2 0 0010.586 2H6zm2 10a1 1 0 10-2 0v3a1 1 0 102 0v-3zm2-3a1 1 0 011 1v5a1 1 0 11-2 0v-5a1 1 0 011-1zm4-1a1 1 0 10-2 0v7a1 1 0 102 0V8z"></path>
                                        </svg>
                                        <span className="ml-3 flex-1 whitespace-nowrap text-left">
                                            Pages
                                        </span>
                                    ...
                                    >
                                        <li>
                                            <a className="group flex items-center rounded-lg p-2 pl-11 text-base text-gray-900 transition duration-75 hover:bg-gray-100">
                                                Pricing
                                            </a>
                                        </li>
                                        <li>
                            ...
                            <div className="space-y-2 pt-2">
                                <a
                                    ...
                                    className="group flex items-center rounded-lg p-2 text-base text-gray-900 transition duration-75 hover:bg-gray-100"
                                >
                                    <svg
                                        className="h-6 w-6 flex-shrink-0 text-gray-500 transition duration-75 group-hover:text-gray-900"
                                        aria-hidden="true"
                    ...
                    <div className="absolute bottom-0 left-0 hidden w-full justify-center space-x-4 bg-white p-4 lg:flex">
                        <a
                            href="#"
